...
wdir = 'D:/TEMP ILIANA/Base de datos regional y Monitor de sequía/Monitor Guajira/02 Mapa de precipitacion mensual/'

# Load and prepare data
df = pd.read_excel("D:/TEMP ILIANA/Base de datos regional y Monitor de sequía/Monitor Guajira/02 Mapa de precipitacion mensual/PREC-OCTUBRE_25.xlsx", 
...
# Reproyectar a un CRS proyectado (metros) para buffer correcto
gdf_projected = gdf_filt.to_crs('EPSG:32717')  # UTM Zone 17S para Ecuador
gdf_buffered = gdf_projected.buffer(5000)  # 5000 metros = 5 km
gdf_buffered = gdf_buffered.to_crs(gdf_filt.crs)  # Volver al CRS original
...
ax.annotate('',xy=(arrow_x, arrow_y),          # Punta de la flecha
